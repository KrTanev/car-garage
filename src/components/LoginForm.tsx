...
export function LoginForm() {
  ...
  return (
    <form className="card w-full max-w-[360px]" onSubmit={handleSubmit}>
      <h2 className="text-[1.1rem] font-semibold text-text mb-3">{t.home.loginTitle}</h2>
      ...
      <input
        ...
        required
      />
      {hasError && <p className="text-danger text-[0.85rem] -mt-2 mb-3">{t.home.loginError}</p>}
      <button type="submit" className="btn-primary mt-3.5" disabled={isSigningIn}>
