    ...
    <main className="max-w-[960px] mx-auto px-4 py-8 pb-16">
      <section className="max-w-[640px] mb-10">
        ...
        <p className="text-text-muted mb-3">
          {t.about.intro(BUSINESS_INFO.foundedYear, yearsInBusiness)}
        </p>
      ...
      <section className="mb-10">
        <h2 className="text-[1.1rem] font-semibold text-text mb-3">{t.about.servicesTitle}</h2>
      ...
      <section className="mb-10">
        <h2 className="text-[1.1rem] font-semibold text-text mb-3">{t.about.galleryTitle}</h2>
